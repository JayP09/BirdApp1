...
const Home = () => {
    ...
    const signup = () => {
        ...
        if(allUser) {
            ...
            console.log(user)
            if (user) {
                return alert("username exist already")
            }
        ...
        <div className="h-screen flex">
            ...
            <div className="flex flex-col w-full lg:w-1/2 items-center bg-black">
                <div className="w-full flex flex-col justify-start items-start px-9">
                    ...
                    <h1 className="text-white font-bold text-6xl w-full my-6">Happening now</h1>
                    <p className="text-3xl font-normal text-[#d9d9d9] mb-8 w-full">Join Twitter today.</p>
                </div>
                <div className="w-full px-8 lg:px-24 mb-24 mt-12">
                    ...
                    <div className="flex justify-between mt-4">
                        <div className="flex justify-center items-center text-[#d9d9d9]">
                            {state ? (<p>Have an account already? </p>): (<p>Don't have an account yet?</p>)}
                            <button className="text-sm text-blue-500 cursor-pointer ml-2" onClick={() => setState((oldvalue) => !oldvalue)}>
